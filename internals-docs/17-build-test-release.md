...
- [Icons](12-icons.md) — the pack data pipeline this generates
- [Localization](16-i18n.md) — the locale data pipeline this generates
- [Architecture](02-architecture.md) — the frozen oversized-file list, `repoSourceRules`
