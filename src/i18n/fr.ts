export const fr: Record<string, string> = {
	...
	"settings.iconSources": "Icônes Google Material",
	"settings.iconSourcesDesc": "Les noms des icônes Material et les balises de recherche sont inclus pour la navigation hors ligne. Google Fonts et les fichiers SVG (fonts.googleapis.com, fonts.gstatic.com) ne sont chargés que lorsque vous prévisualisez ou sélectionnez une icône Material ; les SVG sélectionnés sont ensuite mis en cache localement. Aucune donnée n'est envoyée à Google.",
	...
	"settings.colorPairAria": "Clair : {{light}} · Sombre : {{dark}}",
	...
	"settings.lucideIcons": "Icônes Lucide",
	"settings.lucideIconsDesc": "Icônes intégrées d'Obsidian (~1 300 icônes)",
	"settings.materialIcons": "Icônes Google Material",
	"settings.materialIconsDesc": "Nécessite une connexion internet ou un cache local (~3 000 icônes)",
	"settings.materialStyleDefault": "Style par défaut des icônes Material",
	"settings.styleOutlined": "Contour",
	"settings.styleFilled": "Rempli",
	"settings.styleRounded": "Arrondi",
	"settings.styleSharp": "Acéré",
	"settings.materialWeightDefault": "Épaisseur par défaut des icônes Material",
	"settings.materialWeightDefaultDesc": "Épaisseur du trait pour les icônes Material (100 = fin, 700 = gras)",
	"settings.materialCache": "Cache d'icônes Material",
	"settings.materialCacheDesc": "Les SVG individuels des icônes Material sont téléchargés lorsque vous en sélectionnez un pour un callout, afin qu'ils fonctionnent hors ligne et dans les exports PDF.",
	"settings.svgCache": "SVG téléchargés",
	"settings.svgCacheInfo": "{{count}} icônes · {{size}}",
	"settings.svgCacheEmpty": "Aucun SVG Material en cache pour l'instant.",
	"settings.clearSvgCache": "Vider",
	"settings.viewCachedSvgs": "Voir",
	"settings.cachedSvgsTitle": "SVG Material en cache",
	...
	"notice.exported": "Callouts exportés vers callout-studio-callouts.json",
	...
	"notice.iconDownloadFailed": 'Échec du téléchargement de l\'icône Material "{{name}}". Vérifiez votre connexion internet.',
	...
	"editor.calloutIdsDesc": "Tous les identifiants de ce callout. Appuyez sur Entrée ou Espace pour en ajouter.",
	...
	"editor.palettes": "Préréglages",
	"editor.paletteDefault": "Bleu par défaut",
	...
	"import.err.idBadChar": 'L\'ID "{{value}}" contient des caractères invalides (les espaces, "|", "[" ou "]" ne sont pas autorisés).',
