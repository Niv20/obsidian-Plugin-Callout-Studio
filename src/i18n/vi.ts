export const vi: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "Tất cả các định danh cho callout này. Nhấn Enter hoặc Dấu cách để thêm.",
	...
	"import.err.idBadChar": 'ID "{{value}}" chứa ký tự không hợp lệ (khoảng trắng, "|", "[" hoặc "]" không được phép).',
