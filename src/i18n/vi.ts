export const vi: Record<string, string> = {
	...
	"editor.gradientEnd": "Cuối chuyển sắc",
	"editor.text": "Văn bản",
	...
	"settings.calloutTypeRegularDesc": "Callout trích dẫn khối có nội dung: > [!name]. Luôn được bật.",
	"settings.calloutTypeRegularLocked": "Callout thông thường là cách hiển thị gốc của Obsidian và không thể tắt được.",
	"settings.roleEnabled": "Đã bật",
	...
	"menuCustomize.moveUp": "Di chuyển lên",
	"menuCustomize.moveDown": "Di chuyển xuống",
