export const nb: Record<string, string> = {
	...
	"editor.gradientEnd": "Gradientslutt",
	"editor.text": "Tekst",
	...
	"settings.calloutTypeRegularLocked": "Vanlige callouts er Obsidians innebygde rendering og kan ikke slås av.",
	"settings.roleEnabled": "Aktivert",
