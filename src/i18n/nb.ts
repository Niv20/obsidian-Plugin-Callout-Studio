export const nb: Record<string, string> = {
	...
	"settings.showEditCallout": 'Vis "rediger callout-innstillinger"',
	"settings.showOpenSettings": 'Vis "åpne Callout Studio-innstillinger"',
	"settings.showCopyMarkdown": 'Vis "kopier callout Markdown"',
	...
	"settings.showIconPreviews": "Vis ikonforhåndsvisninger i autofullføring",
	"settings.showColorPreviews": "Vis fargeforhåndsvisninger",
	...
	"editor.calloutIdsDesc": "Alle identifikatorer for denne callout-en. Trykk Enter eller Mellomrom for å legge til.",
	...
	"import.err.idBadChar": 'ID-en "{{value}}" inneholder ugyldige tegn (mellomrom, "|", "[" eller "]" er ikke tillatt).',
