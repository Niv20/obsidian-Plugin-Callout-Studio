export const bg: Record<string, string> = {
	...
	"editor.gradientEnd": "Край на градиента",
	"editor.text": "Текст",
	...
	"settings.calloutTypeRegularLocked": "Обикновените callout-и са нативното визуализиране на Obsidian и не могат да бъдат изключени.",
	"settings.roleEnabled": "Активен",
