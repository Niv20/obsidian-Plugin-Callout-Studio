export const bg: Record<string, string> = {
	...
	"settings.showEditCallout": 'Показване на "редактиране на настройките на callout"',
	"settings.showOpenSettings": 'Показване на "отваряне на настройките на Callout Studio"',
	"settings.showCopyMarkdown": 'Показване на "копиране на Markdown на callout"',
	...
	"settings.showIconPreviews": "Показване на прегледи на икони в автоматичното довършване",
	"settings.showColorPreviews": "Показване на прегледи на цветове",
	...
	"editor.calloutIdsDesc": "Всички идентификатори за този callout. Натиснете Enter или интервал за добавяне.",
	...
	"import.err.idBadChar": 'ID-то "{{value}}" съдържа невалидни символи (интервали, "|", "[" или "]" не се разрешават).',
