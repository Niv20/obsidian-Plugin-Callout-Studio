export const hu: Record<string, string> = {
	...
	"editor.gradientEnd": "Színátmenet vége",
	"editor.text": "Szöveg",
	...
	"settings.calloutTypeRegularLocked": "A normál callout-ok az Obsidian natív megjelenítése, és nem kapcsolhatók ki.",
	"settings.roleEnabled": "Engedélyezve",
