export const hu: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "Ennek a callout-nak az összes azonosítója. Nyomja meg az Enter vagy a Szóköz billentyűt a hozzáadáshoz.",
	...
	"import.err.idBadChar": 'A "{{value}}" azonosító érvénytelen karaktereket tartalmaz (szóköz, "|", "[" vagy "]" nem megengedett).',
