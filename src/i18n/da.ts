export const da: Record<string, string> = {
	...
	"firstRun.heavyVaultNote":
		"Din vault har {{count}} Markdown-filer — scanningen kan tage et par sekunder.",
	"firstRun.laterHint":
		"Du kan altid køre dette senere fra Indstillinger → Vault-indsigt og vedligeholdelse → Genscann vault.",
	"firstRun.scanNow": "Scann nu",
	"firstRun.noThanks": "Nej tak",
	"firstRun.autoScanComplete":
		"Callout Studio scannede din vault og tilføjede {{count}} callout(s).",
	...
	"locale.notDownloadedDesc": "Callout Studio viser engelsk, indtil oversættelsen kan downloades. Der forsøges igen, næste gang Obsidian starter.",
	"locale.retry": "Prøv igen",
	"locale.diskWriteFailed": "Callout Studio kunne ikke gemme oversættelsen på disken, så den skal downloades igen næste gang.",
	...
	"notice.exportCssEmpty": "Der er ingen brugerdefinerede callouts at eksportere.",
	"notice.exportCssFailed": "CSS-udsnittet kunne ikke gemmes. Se udviklerkonsollen for detaljer.",
	"notice.exportCssEnabled": "Dette udsnit er slået til i denne vault. Callout Studio styler allerede disse callouts, og udsnittet bevarer stilen fra eksporttidspunktet.",
	"confirm.titleOverwriteSnippet": "Overskriv CSS-udsnit",
	"confirm.overwriteSnippet": "CSS-udsnittet i din snippets-mappe er ændret, siden Callout Studio skrev det. En ny eksport erstatter hele filen.",
	"confirm.overwriteSnippetOk": "Overskriv",
	"export.chooseFormat": "Eksportér som",
	"export.formatJson": "Callout Studio-sikkerhedskopi",
	"export.formatJsonDesc": "En .json-fil med dine callouts og indstillinger til import i en anden vault.",
	"export.formatCss": "CSS-udsnit",
	"export.formatCssDesc": "En .css-fil gemt i denne vaults snippets-mappe til brug, hvor Callout Studio ikke er installeret. Den dækker kun almindelige callouts og er et øjebliksbillede; eksportér igen efter ændringer.",
};
