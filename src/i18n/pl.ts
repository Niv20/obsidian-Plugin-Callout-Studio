export const pl: Record<string, string> = {
	...
	"settings.iconSourcesDesc": "Nazwy ikon Material i tagi wyszukiwania są dołączone do przeglądania offline. Google Fonts i pliki SVG (fonts.googleapis.com, fonts.gstatic.com) są ładowane tylko podczas podglądu lub wybierania ikony Material; wybrane SVG są następnie buforowane lokalnie. Żadne dane nie są wysyłane do Google.",
	...
	"settings.colorPairAria": "Jasny: {{light}} · Ciemny: {{dark}}",
	...
	"settings.lucideIconsDesc": "Wbudowane ikony Obsidian (~1 300 ikon)",
	"settings.materialIcons": "Ikony Google Material",
	"settings.materialIconsDesc": "Wymaga internetu lub lokalnej pamięci podręcznej (~3 000 ikon)",
	"settings.materialStyleDefault": "Domyślny styl ikon Material",
	"settings.styleOutlined": "Konturowy",
	"settings.styleFilled": "Wypełniony",
	"settings.styleRounded": "Zaokrąglony",
	"settings.styleSharp": "Ostry",
	"settings.materialWeightDefault": "Domyślna grubość ikon Material",
	"settings.materialWeightDefaultDesc": "Grubość kreski dla ikon Material (100 = cienka, 700 = pogrubiona)",
	"settings.materialCache": "Pamięć podręczna ikon Material",
	"settings.materialCacheDesc": "Poszczególne SVG ikon Material są pobierane po wybraniu ikony dla callout, aby działały offline i przy eksporcie PDF.",
	"settings.svgCache": "Pobrane SVG",
	"settings.svgCacheInfo": "{{count}} ikon · {{size}}",
	"settings.svgCacheEmpty": "Brak buforowanych SVG Material.",
	"settings.clearSvgCache": "Wyczyść",
	"settings.viewCachedSvgs": "Przeglądaj",
	"settings.cachedSvgsTitle": "Buforowane SVG Material",
	...
	"settings.resetAllDesc": "Usuwa wszystkie callouts użytkownika, resetuje wbudowane callouts, globalne style (obramowania, skala czcionki, kształt) i pobrane SVG Material.",
	"settings.resetAllButton": "Resetuj wszystko",
	"settings.resetAllConfirm": "Spowoduje to usunięcie wszystkich niestandardowych callouts, zresetowanie wbudowanych callouts, globalnych stylów i wszystkich buforowanych SVG Material. Tej akcji nie można cofnąć. Czy jesteś pewien?",
	...
	"notice.iconDownloadFailed": 'Nie można pobrać ikony Material "{{name}}". Sprawdź połączenie internetowe.',
	...
	"editor.calloutIdsDesc": "Wszystkie identyfikatory tego callout. Naciśnij Enter lub Spację, aby dodać.",
	...
	"editor.palettes": "Presety",
	"editor.paletteDefault": "Domyślny niebieski",
	...
	"import.err.idBadChar": 'ID "{{value}}" zawiera nieprawidłowe znaki (spacje, "|", "[" lub "]" są niedozwolone).',
