export const pt: Record<string, string> = {
	...
	"editor.idDashConflict": 'O Obsidian grava espaços como hífens, por isso este ID entra em conflito com "{{other}}"',
	...
	"palette.baseColorHint": "Ajustaremos automaticamente a cor de fundo a esta. Se preferir, pode controlá-la separadamente ao {{link}}.",
	"palette.baseColorHintLink": "clicar aqui",
	"palette.advancedColors": "Cores",
	"palette.advancedColorsHint": "A editar as cores para o modo {{mode}} - o outro modo é atualizado automaticamente. Mude o tema do Obsidian para verificar.",
	...
	"iconPicker.tablerStyleOutline": "Contorno",
	"iconPicker.tablerStyleFilled": "Preenchido",
	...
	"iconPicker.faStyleSolid": "Sólido",
	"iconPicker.faStyleRegular": "Regular",
	"iconPicker.faStyleBrands": "Marcas",
	...
	"iconPicker.imageTooLarge": "{{name}} é demasiado grande. As imagens devem ter menos de 5 MB.",
	"iconPicker.imageUnsupported": "{{name}} não é um formato de imagem suportado. Use SVG, PNG, JPEG ou WebP.",
	"iconPicker.imageInvalidSvg": "{{name}} não foi possível ler como SVG seguro e não foi adicionado.",
	"iconPicker.imageDecodeFailed": "{{name}} não foi possível ler como imagem.",
	"iconPicker.imageDuplicate": "{{name}} já está nas suas imagens. Renomeie o ficheiro ou elimine a imagem existente.",
	"iconPicker.imageAdd": "Adicionar imagens",
	"iconPicker.imageEmpty": "Ainda sem imagens. Adicione um ficheiro SVG, PNG, JPEG ou WebP do seu computador, ou arraste-o para aqui.",
	"iconPicker.imageDelete": "Eliminar",
	"iconPicker.imageDeleteConfirm": "Eliminar “{{name}}”?",
	"iconPicker.imageDeleteInUse": "{{count}} callouts utilizam esta imagem. Mostrarão um ícone de marcador de posição até que forneça um novo.",
	...
	"iconPicker.sourcesNotDownloaded": "Ainda não incluído: {{names}}. Escolha uma fonte acima para o descarregar.",
	...
	"iconPicker.descTabler": "ícones de interface limpos e consistentes, contorno e preenchido",
	"iconPicker.descMaterial": "o conjunto do Google, quatro estilos e sete espessuras",
	...
	"iconPack.downloadDetail": "{{count}} ícones · {{size}} · descarregamento único",
	"iconPack.download": "Descarregar",
	"iconPack.downloading": "A descarregar {{name}}…",
	"iconPack.downloadFailed": "Não foi possível descarregar {{name}}. Verifique a ligação e tente novamente.",
	"iconPack.retry": "Tentar novamente",
	"iconPack.faBrandsNotice": "Os ícones de marcas são marcas registadas dos respetivos proprietários. A sua inclusão não indica aprovação. Por favor, utilize-os apenas para representar a empresa, produto ou serviço a que se referem.",
	"iconPack.artworkRestored": "O artwork dos ícones para {{names}} foi descarregado.",
	"iconPack.diskWriteFailed": "O Callout Studio não conseguiu guardar o pacote de ícones no disco, pelo que precisará de ser descarregado novamente na próxima vez. Os ícones que escolher continuam guardados nas suas definições.",

	// Icon licences & credits
	"credits.title": "Licenças de ícones e créditos",
	"credits.intro": "O Callout Studio baseia-se em várias bibliotecas de ícones abertas. As suas licenças são reproduzidas abaixo, juntamente com o que foi modificado para as utilizar aqui.",
	"credits.fullNotices": "Avisos completos de terceiros",
	"credits.pluginLicense": "O código do Callout Studio está sob a licença 0BSD; as bibliotecas de ícones mantêm as suas próprias licenças.",
	...
	"import.err.iconTypeInvalid": "O tipo de ícone \"{{value}}\" não é um de: {{types}}.",
	"import.warn.iconFieldIgnored": "\"{{field}}\" aplica-se apenas a ícones Material e é ignorado para o tipo de ícone {{type}}.",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\" aplica-se apenas às suas próprias imagens e é ignorado para o tipo de ícone {{type}}.",
	"import.err.iconRecolorInvalid": "\"recolor\" deve ser true ou false (recebido: \"{{value}}\").",
	...
	"import.warn.imageMissing": "Este Callout usa uma imagem que não está no ficheiro nem neste vault, pelo que mostrará um ícone de marcador de posição até que forneça um novo.",
