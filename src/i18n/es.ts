export const es: Record<string, string> = {
	...
	"welcome.tagline": "Su solución completa para gestionar callouts de Obsidian.",
	...
	"editor.gradientEnd": "Fin del degradado",
	"editor.text": "Texto",
	...
	"editor.idDashConflict": 'Obsidian escribe los espacios como guiones, por lo que este ID coincide con "{{other}}"',
	...
	"palette.baseColorHint": "Ajustaremos automáticamente el color de fondo a este. Si lo prefieres, puedes controlarlo por separado {{link}}.",
	"palette.baseColorHintLink": "haciendo clic aquí",
	"palette.advancedColors": "Colores",
	"palette.advancedColorsHint": "Editando los colores del modo {{mode}}: el otro modo se actualiza automáticamente. Cambia el tema de Obsidian para comprobarlo.",
	...
	"iconPicker.tablerStyleFilled": "Relleno",
	...
	"iconPicker.imageTooLarge": "{{name}} es demasiado grande. Las imágenes deben ser menores de 5 MB.",
	"iconPicker.imageUnsupported": "{{name}} no es un formato de imagen compatible. Usa SVG, PNG, JPEG o WebP.",
	"iconPicker.imageInvalidSvg": "{{name}} no se pudo leer como SVG seguro y no se añadió.",
	"iconPicker.imageDecodeFailed": "{{name}} no se pudo leer como imagen.",
	"iconPicker.imageDuplicate": "{{name}} ya está en tus imágenes. Renombra el archivo o elimina la imagen existente.",
	"iconPicker.imageAdd": "Añadir imágenes",
	"iconPicker.imageEmpty": "Todavía no hay imágenes. Añade un archivo SVG, PNG, JPEG o WebP desde tu ordenador o arrástralo aquí.",
	"iconPicker.imageDelete": "Eliminar",
	"iconPicker.imageDeleteConfirm": "¿Eliminar “{{name}}”?",
	"iconPicker.imageDeleteInUse": "{{count}} callouts usan esta imagen. Mostrarán un icono de marcador de posición hasta que proporciones uno nuevo.",
	...
	"iconPicker.sourcesNotDownloaded": "Aún no incluido: {{names}}. Selecciona una fuente arriba para descargarlo.",
	"iconPicker.chooseSource": "Elegir fuente",
	"iconPicker.sourceGroup": "{{name}} · {{count}}",

	// Source menu — what each library holds, in a few words
	"iconPicker.descAllSources": "buscar en todas las bibliotecas a la vez",
	"iconPicker.descLucide": "el conjunto propio de Obsidian, siempre sin conexión",
	"iconPicker.descTabler": "iconos de interfaz limpios y consistentes, contorno y relleno",
	"iconPicker.descMaterial": "el conjunto de Google, cuatro estilos y siete pesos",
	...
	"iconPack.downloadFailed": "No se pudo descargar {{name}}. Comprueba tu conexión e inténtalo de nuevo.",
	"iconPack.retry": "Reintentar",
	"iconPack.faBrandsNotice": "Los iconos de marcas son marcas registradas de sus respectivos propietarios. Su inclusión no indica endorsamiento. Por favor, úsalos solo para representar la empresa, producto o servicio al que se refieren.",
	"iconPack.artworkRestored": "Se descargó el arte de los iconos para {{names}}.",
	"iconPack.diskWriteFailed": "Callout Studio no pudo guardar el paquete de iconos en disco, por lo que tendrá que descargarse de nuevo la próxima vez. Los iconos que elijas siguen guardados en tu configuración.",

	// Icon licences & credits
	"credits.title": "Licencias de iconos y créditos",
	"credits.intro": "Callout Studio se basa en varias bibliotecas de iconos abiertas. Sus licencias se reproducen a continuación, junto con lo que se modificó para usarlas aquí.",
	"credits.fullNotices": "Avisos completos de terceros",
	"credits.pluginLicense": "El código propio de Callout Studio está bajo la licencia 0BSD; las bibliotecas de iconos conservan sus propias licencias.",
	...
	"settings.calloutTypeRegularLocked":
		"Los callouts regulares son el renderizado nativo de Obsidian y no se pueden desactivar.",
	...
	"import.err.iconTypeInvalid": "El tipo de icono \"{{value}}\" no es uno de: {{types}}.",
	"import.warn.iconFieldIgnored": "\"{{field}}\" solo se aplica a iconos de Material y se ignora para el tipo de icono {{type}}.",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\" solo se aplica a tus propias imágenes y se ignora para el tipo de icono {{type}}.",
	"import.err.iconRecolorInvalid": "\"recolor\" debe ser true o false (se recibió \"{{value}}\").",
	...
	"import.warn.imageMissing": "Este Callout usa una imagen que no está en el archivo ni en este vault, por lo que mostrará un icono de marcador de posición hasta que le des uno nuevo.",
