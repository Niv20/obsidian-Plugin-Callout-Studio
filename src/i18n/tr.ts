export const tr: Record<string, string> = {
	...
	"settings.iconSources": "Google Material simgeleri",
	"settings.iconSourcesDesc": "Material simge adları ve arama etiketleri çevrimdışı göz atma için birlikte gelir. Google Fonts ve SVG dosyaları (fonts.googleapis.com, fonts.gstatic.com) yalnızca bir Material simgesini önizlediğinizde veya seçtiğinizde yüklenir; seçilen SVG'ler yerel olarak önbelleğe alınır. Google'a herhangi bir veri gönderilmez.",
	...
	"settings.lucideIcons": "Lucide simgeleri",
	"settings.lucideIconsDesc": "Obsidian yerleşik simgeleri (~1.300 simge)",
	"settings.materialIcons": "Google Material simgeleri",
	"settings.materialIconsDesc": "İnternet veya yerel önbellek gerektirir (~3.000 simge)",
	"settings.materialStyleDefault": "Material simge varsayılan stili",
	"settings.styleOutlined": "Çizgili",
	"settings.styleFilled": "Dolu",
	"settings.styleRounded": "Yuvarlak",
	"settings.styleSharp": "Keskin",
	"settings.materialWeightDefault": "Material simge varsayılan ağırlığı",
	"settings.materialWeightDefaultDesc": "Material simgeler için vuruş kalınlığı (100 = ince, 700 = kalın)",
	"settings.materialCache": "Material simge önbelleği",
	"settings.materialCacheDesc": "Bir callout için simge seçtiğinizde tek tek Material SVG'ler indirilir, böylece çevrimdışı ve PDF dışa aktarmada çalışırlar.",
	"settings.svgCache": "İndirilen SVG'ler",
	"settings.svgCacheInfo": "{{count}} simge · {{size}}",
	"settings.svgCacheEmpty": "Henüz önbelleğe alınmış Material SVG yok.",
	"settings.clearSvgCache": "Temizle",
	"settings.viewCachedSvgs": "Görüntüle",
	"settings.cachedSvgsTitle": "Önbelleğe alınmış Material SVG'ler",
	...
	"editor.calloutIdsDesc": "Bu callout için tüm tanımlayıcılar. Eklemek için Enter veya Boşluk tuşuna basın.",
	...
	"import.err.idBadChar": '"{{value}}" ID\'si geçersiz karakterler içeriyor (boşluk, "|", "[" veya "]" kullanılamaz).',
