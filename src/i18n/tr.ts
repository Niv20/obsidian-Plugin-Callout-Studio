export const tr: Record<string, string> = {
	...
	"locale.notDownloadedDesc": "Callout Studio, çeviri indirilene kadar İngilizce gösterir. Obsidian bir sonraki başlatıldığında tekrar deneyecek.",
	"locale.retry": "Yeniden dene",
	"locale.diskWriteFailed": "Callout Studio çeviriyi diske kaydedemedi; bu nedenle bir dahaki sefere yeniden indirilmesi gerekecek.",
	...
	"notice.exportCssFailed": "CSS snippet kaydedilemedi. Ayrıntılar için geliştirici konsolunu kontrol edin.",
	"notice.exportCssEnabled": "Bu snippet vault içinde açık. Callout Studio bu callout'ları zaten biçimlendiriyor ve snippet dışa aktarıldığı zamanki stili koruyor.",
	"confirm.titleOverwriteSnippet": "CSS snippet'in üzerine yaz",
	"confirm.overwriteSnippet": "Snippets klasöründeki CSS snippet, Callout Studio yazdıktan sonra değişti. Yeniden dışa aktarma dosyanın tamamını değiştirir.",
	"confirm.overwriteSnippetOk": "Üzerine yaz",
	"export.chooseFormat": "Şu biçimde dışa aktar",
	"export.formatJson": "Callout Studio yedeği",
	"export.formatJsonDesc": "Callout'larınızı ve ayarlarınızı başka bir vault'a aktarmak için bir .json dosyası.",
	"export.formatCss": "CSS snippet",
	"export.formatCssDesc": "Callout Studio'nun kurulu olmadığı yerlerde kullanmak üzere bu vault'un snippets klasörüne kaydedilen .css dosyası. Yalnızca normal callout'ları kapsar ve bir anlık görüntüdür; değişiklikten sonra yeniden dışa aktarın.",
};
