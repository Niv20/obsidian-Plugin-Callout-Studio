export const de: Record<string, string> = {
	...
	"editor.idDashConflict": 'Obsidian schreibt Leerzeichen als Bindestriche, daher kollidiert diese ID mit „{{other}}“',
	...
	"palette.baseColorHint": "Wir passen die Hintergrundfarbe automatisch daran an. Wenn du möchtest, kannst du sie separat steuern, indem du {{link}}.",
	"palette.baseColorHintLink": "hier klickst",
	"palette.advancedColors": "Farben",
	"palette.advancedColorsHint": "Bearbeiten der Farben für den {{mode}}-Modus – der andere Modus wird automatisch aktualisiert. Wechsle das Obsidian-Theme, um es zu überprüfen.",
	"palette.revertHint": "Bevorzugst du stattdessen eine einzelne Basisfarbe? {{link}}.",
	...
	"iconPicker.tablerStyleFilled": "Gefüllt",
	...
	"iconPicker.faStyleSolid": "Ausgefüllt",
	"iconPicker.faStyleRegular": "Regulär",
	"iconPicker.faStyleBrands": "Marken",
	...
	"iconPicker.imageTooLarge": "{{name}} ist zu groß. Bilder müssen kleiner als 5 MB sein.",
	"iconPicker.imageUnsupported": "{{name}} ist kein unterstütztes Bildformat. Verwenden Sie SVG, PNG, JPEG oder WebP.",
	"iconPicker.imageInvalidSvg": "{{name}} konnte nicht als sicheres SVG gelesen werden und wurde nicht hinzugefügt.",
	"iconPicker.imageDecodeFailed": "{{name}} konnte nicht als Bild gelesen werden.",
	"iconPicker.imageDuplicate": "{{name}} ist bereits in Ihren Bildern. Benennen Sie die Datei um oder löschen Sie das vorhandene Bild.",
	"iconPicker.imageAdd": "Bilder hinzufügen",
	"iconPicker.imageEmpty": "Noch keine Bilder. Fügen Sie eine SVG-, PNG-, JPEG- oder WebP-Datei von Ihrem Computer hinzu oder ziehen Sie eine hierher.",
	"iconPicker.imageDelete": "Löschen",
	"iconPicker.imageDeleteConfirm": "„{{name}}“ löschen?",
	"iconPicker.imageDeleteInUse": "{{count}} Callout(s) verwendet dieses Bild. Es wird ein Platzhalter-Symbol angezeigt, bis Sie ein neues festlegen.",
	...
	"iconPicker.sourcesNotDownloaded": "Noch nicht enthalten: {{names}}. Wählen Sie oben eine Quelle, um sie herunterzuladen.",
	...
	"iconPicker.descTabler": "klare und einheitliche UI-Symbole, Kontur und gefüllt",
	"iconPicker.descMaterial": "Googles Sammlung, vier Stile und sieben Stärken",
	...
	"iconPack.downloadDetail": "{{count}} Symbole · {{size}} · Einmaliger Download",
	"iconPack.download": "Herunterladen",
	"iconPack.downloading": "{{name}} wird heruntergeladen…",
	"iconPack.downloadFailed": "{{name}} konnte nicht heruntergeladen werden. Überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
	"iconPack.retry": "Erneut versuchen",
	"iconPack.faBrandsNotice": "Marken-Symbole sind Markenzeichen ihrer jeweiligen Eigentümer. Ihre Aufnahme impliziert keine Empfehlung. Bitte verwenden Sie sie nur zur Darstellung des Unternehmens, Produkts oder der Dienstleistung, für das sie stehen.",
	"iconPack.artworkRestored": "Die Symbol-Grafiken für {{names}} wurden heruntergeladen.",
	"iconPack.diskWriteFailed": "Callout Studio konnte das Symbol-Paket nicht auf der Festplatte speichern; es muss beim nächsten Mal erneut heruntergeladen werden. Die ausgewählten Symbole werden weiterhin mit Ihren Einstellungen gespeichert.",

	// Icon licences & credits
	"credits.title": "Symbol-Lizenzen und Quellenangaben",
	"credits.intro": "Callout Studio nutzt mehrere offene Symbol-Bibliotheken. Ihre Lizenzen sind nachfolgend wiedergegeben, zusammen mit den vorgenommenen Anpassungen für die hiesige Verwendung.",
	"credits.fullNotices": "Vollständige Drittanbieter-Hinweise",
	"credits.pluginLicense": "Callout Studios eigener Code steht unter der 0BSD-Lizenz; die Symbol-Bibliotheken behalten ihre eigenen Lizenzen.",
	...
	"import.err.iconTypeInvalid": "Der Symboltyp \"{{value}}\" ist keiner der folgenden: {{types}}.",
	"import.warn.iconFieldIgnored": "\"{{field}}\" gilt nur für Material-Symbole und wird für den Symboltyp {{type}} ignoriert.",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\" gilt nur für eigene Bilder und wird für den Symboltyp {{type}} ignoriert.",
	"import.err.iconRecolorInvalid": "\"recolor\" muss true oder false sein (Wert: \"{{value}}\").",
	...
	"import.warn.imageMissing": "Dieser Callout verwendet ein Bild, das weder in der Datei noch im Vault vorhanden ist; es wird ein Platzhalter-Symbol angezeigt, bis Sie ein neues festlegen.",
