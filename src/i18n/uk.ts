export const uk: Record<string, string> = {
	...
	"welcome.tagline": "Ваше повне рішення для керування callout в Obsidian.",
	"welcome.previewTitle": "Побачити в дії",
	"welcome.sample":
		"Callout Studio дозволяє створювати callout із власною іконкою, кольорами та назвою.\n\n" +
		"Один і той самий callout можна використовувати **трьома** різними способами:\n\n" +
		"## [!tip] Як заголовок\n" +
		"Щоб перетворити будь-який заголовок на заголовок у стилі callout, додайте `[!type]` одразу після `#`.\n\n" +
		"Хочете вбудований callout, як цей [!warning]? Просто додайте `[!type]` прямо посеред речення, не перериваючи текст.\n\n" +
		"> [!note] Звичайний callout\n" +
		"> Звісно, класичний callout працює за тим самим синтаксисом, до якого ви вже звикли: `> [!type]`.\n\n" +
	...
	"locale.notDownloadedDesc": "Callout Studio показує англійську, доки переклад не буде завантажено. Наступного запуску Obsidian буде повторна спроба.",
	"locale.retry": "Повторити",
	"locale.diskWriteFailed": "Callout Studio не вдалося зберегти переклад на диск, тому наступного разу його потрібно буде завантажити знову.",
	...
	"notice.exportCssFailed": "Не вдалося зберегти фрагмент CSS. Докладніше дивіться в консолі розробника.",
	"notice.exportCssEnabled": "Цей фрагмент увімкнено в цьому vault. Callout Studio уже стилізує ці callout, а фрагмент зберігає стиль на момент експорту.",
	"confirm.titleOverwriteSnippet": "Перезаписати фрагмент CSS",
	"confirm.overwriteSnippet": "Фрагмент CSS у папці snippets змінився після того, як Callout Studio його записав. Повторний експорт замінить увесь файл.",
	...
	"export.formatJsonDesc": "Файл .json із вашими callout і налаштуваннями для імпорту в інший vault.",
	"export.formatCss": "Фрагмент CSS",
	"export.formatCssDesc": "Файл .css, збережений у папці snippets цього vault для використання там, де Callout Studio не встановлено. Він охоплює лише звичайні callout і є знімком; експортуйте його знову після змін.",
};
