export const uk: Record<string, string> = {
	...
	"editor.gradientEnd": "Кінець градієнта",
	"editor.text": "Текст",
	...
	"settings.calloutTypeRegularLocked": "Звичайні callout — це вбудований рендеринг Obsidian, і їх не можна вимкнути.",
	"settings.roleEnabled": "Увімкнено",
