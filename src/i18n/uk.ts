export const uk: Record<string, string> = {
	...
	"settings.iconSources": "Іконки Google Material",
	"settings.iconSourcesDesc": "Назви іконок Material і теги пошуку постачаються разом для офлайн-перегляду. Google Fonts і SVG-файли (fonts.googleapis.com, fonts.gstatic.com) завантажуються лише під час перегляду або вибору іконки Material; вибрані SVG кешуються локально. Дані Google не передаються.",
	...
	"settings.lucideIcons": "Іконки Lucide",
	"settings.lucideIconsDesc": "Вбудовані іконки Obsidian (~1 300 іконок)",
	"settings.materialIcons": "Іконки Google Material",
	"settings.materialIconsDesc": "Потрібен інтернет або локальний кеш (~3 000 іконок)",
	"settings.materialStyleDefault": "Стиль іконок Material за замовчуванням",
	"settings.styleOutlined": "Контурний",
	"settings.styleFilled": "Заповнений",
	"settings.styleRounded": "Округлений",
	"settings.styleSharp": "Гострий",
	"settings.materialWeightDefault": "Товщина іконок Material за замовчуванням",
	"settings.materialWeightDefaultDesc": "Товщина штриха іконок Material (100 = тонкий, 700 = жирний)",
	"settings.materialCache": "Кеш іконок Material",
	"settings.materialCacheDesc": "Окремі SVG іконок Material завантажуються при виборі іконки для callout, щоб вони працювали офлайн і при експорті в PDF.",
	"settings.svgCache": "Завантажені SVG",
	"settings.svgCacheInfo": "{{count}} іконок · {{size}}",
	"settings.svgCacheEmpty": "SVG Material ще не кешовані.",
	"settings.clearSvgCache": "Очистити",
	"settings.viewCachedSvgs": "Переглянути",
	"settings.cachedSvgsTitle": "Кешовані SVG Material",
	...
	"editor.calloutIdsDesc": "Всі ідентифікатори цього callout. Натисніть Enter або пробіл для додавання.",
	...
	"import.err.idBadChar": 'ID «{{value}}» містить недійсні символи (пробіли, «|», «[» або «]» не дозволені).',
