export const ro: Record<string, string> = {
	...
	"settings.iconSources": "Pictograme Google Material",
	"settings.iconSourcesDesc": "Numele pictogramelor Material și etichetele de căutare sunt incluse pentru navigare offline. Google Fonts și fișierele SVG (fonts.googleapis.com, fonts.gstatic.com) se încarcă doar când previzualizați sau selectați o pictogramă Material; SVG-urile selectate sunt stocate local în cache. Nu se trimit date către Google.",
	...
	"settings.colorPairAria": "Deschis: {{light}} · Închis: {{dark}}",
	...
	"settings.lucideIcons": "Pictograme Lucide",
	"settings.lucideIconsDesc": "Pictograme integrate Obsidian (~1.300 pictograme)",
	"settings.materialIcons": "Pictograme Google Material",
	"settings.materialIconsDesc": "Necesită internet sau cache local (~3.000 pictograme)",
	"settings.materialStyleDefault": "Stilul implicit pictograme Material",
	"settings.styleOutlined": "Contur",
	"settings.styleFilled": "Umplut",
	"settings.styleRounded": "Rotunjit",
	"settings.styleSharp": "Ascuțit",
	"settings.materialWeightDefault": "Grosimea implicită pictograme Material",
	"settings.materialWeightDefaultDesc": "Grosimea trăsăturii pentru pictogramele Material (100 = subțire, 700 = îngroșat)",
	"settings.materialCache": "Cache pictograme Material",
	"settings.materialCacheDesc": "SVG-urile individuale ale pictogramelor Material sunt descărcate când selectați unul pentru un callout, pentru a funcționa offline și la exportul PDF.",
	"settings.svgCache": "SVG-uri descărcate",
	"settings.svgCacheInfo": "{{count}} pictograme · {{size}}",
	"settings.svgCacheEmpty": "Niciun SVG Material în cache încă.",
	"settings.clearSvgCache": "Șterge cache",
	"settings.viewCachedSvgs": "Vizualizare",
	"settings.cachedSvgsTitle": "SVG-uri Material în cache",
	...
	"editor.calloutIdsDesc": "Toți identificatorii pentru acest callout. Apăsați Enter sau Spațiu pentru a adăuga.",
	...
	"editor.palettes": "Presetări",
	"editor.paletteDefault": "Albastru implicit",
	...
	"import.err.idBadChar": 'ID-ul "{{value}}" conține caractere invalide (spații, "|", "[" sau "]" nu sunt permise).',
