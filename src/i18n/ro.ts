export const ro: Record<string, string> = {
	...
	"editor.gradientEnd": "Sfârșit degrade",
	"editor.text": "Text",
	...
	"settings.calloutTypeRegularLocked": "Callout-urile obișnuite sunt randarea nativă a Obsidian și nu pot fi dezactivate.",
	"settings.roleEnabled": "Activat",
