export const el: Record<string, string> = {
	...
	"settings.showEditCallout": 'Εμφάνιση "επεξεργασία ρυθμίσεων callout"',
	"settings.showOpenSettings": 'Εμφάνιση "άνοιγμα ρυθμίσεων Callout Studio"',
	"settings.showCopyMarkdown": 'Εμφάνιση "αντιγραφή Markdown callout"',
	...
	"settings.showIconPreviews": "Εμφάνιση προεπισκοπήσεων εικονιδίων στην αυτόματη συμπλήρωση",
	"settings.showColorPreviews": "Εμφάνιση προεπισκοπήσεων χρωμάτων",
	...
	"editor.calloutIdsDesc": "Όλα τα αναγνωριστικά για αυτό το callout. Πατήστε Enter ή Κενό για προσθήκη.",
	...
	"import.err.idBadChar": 'Το ID "{{value}}" περιέχει μη έγκυρους χαρακτήρες (κενά, "|", "[" ή "]" δεν επιτρέπονται).',
