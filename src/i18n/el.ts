export const el: Record<string, string> = {
	...
	"settings.customizeMenuDesc": "Επιλέξτε ποιες ενέργειες δεξιού κλικ εμφανίζονται για κάθε τύπο callout και αλλάξτε τη σειρά τους.",
	"settings.customizeMenuButton": "Προσαρμογή στοιχείων μενού",
	"menuCustomize.title": "Προσαρμογή μενού δεξιού κλικ",
	"menuCustomize.desc": "Ενεργοποιήστε ή απενεργοποιήστε ενέργειες και αλλάξτε τη σειρά τους με τα βέλη. Οι αλλαγές αποθηκεύονται αυτόματα.",
