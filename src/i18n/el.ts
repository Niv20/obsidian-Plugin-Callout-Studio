export const el: Record<string, string> = {
	...
	"settings.customizeMenuDesc": "Επιλέξτε ποιες ενέργειες δεξιού κλικ εμφανίζονται για κάθε τύπο callout και αλλάξτε τη σειρά τους. Λειτουργεί στη λειτουργία ανάγνωσης, στη λειτουργία πηγής και στην Ζωντανή Προεπισκόπηση.",
