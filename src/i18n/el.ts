export const el: Record<string, string> = {
	...
	"editor.gradientEnd": "Τέλος διαβάθμισης",
	"editor.text": "Κείμενο",
	...
	"settings.calloutTypeRegularLocked":
		"Τα κανονικά callouts αποτελούν την εγγενή απόδοση του Obsidian και δεν μπορούν να απενεργοποιηθούν.",
	"settings.roleEnabled": "Ενεργοποιημένο",
