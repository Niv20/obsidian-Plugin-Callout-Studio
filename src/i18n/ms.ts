export const ms: Record<string, string> = {
	...
	"settings.iconSourcesDesc": "Nama ikon Material dan tag carian disertakan untuk melayari luar talian. Google Fonts dan fail SVG (fonts.googleapis.com, fonts.gstatic.com) hanya dimuatkan apabila anda mempratonton atau memilih ikon Material; SVG yang dipilih kemudian dicache secara tempatan. Tiada data dihantar ke Google.",
	...
	"settings.enableContextMenuDesc": "Menambah tindakan tambahan ke menu klik kanan Obsidian apabila anda mengklik kanan pada callout. Berfungsi dalam paparan baca, mod sumber, dan Pratonton Langsung.",
	"settings.showEditCallout": 'Tunjukkan "edit tetapan callout"',
	"settings.showOpenSettings": 'Tunjukkan "buka tetapan Callout Studio"',
	"settings.showCopyMarkdown": 'Tunjukkan "salin Markdown callout"',
	...
	"settings.showIconPreviews": "Tunjukkan pratonton ikon dalam lengkap automatik",
	"settings.showColorPreviews": "Tunjukkan pratonton warna",
	...
	"settings.lucideIconsDesc": "Ikon terbina dalam Obsidian (~1,300 ikon)",
	"settings.materialIcons": "Ikon Google Material",
	"settings.materialIconsDesc": "Memerlukan internet atau cache tempatan (~3,000 ikon)",
	"settings.materialStyleDefault": "Gaya lalai ikon Material",
	"settings.styleOutlined": "Garis luar",
	"settings.styleFilled": "Terisi",
	"settings.styleRounded": "Bulat",
	"settings.styleSharp": "Tajam",
	"settings.materialWeightDefault": "Ketebalan lalai ikon Material",
	"settings.materialWeightDefaultDesc": "Ketebalan garisan untuk ikon Material (100 = nipis, 700 = tebal)",
	"settings.materialCache": "Cache ikon Material",
	"settings.materialCacheDesc": "SVG ikon Material individu dimuat turun apabila anda memilih untuk callout, supaya ia berfungsi luar talian dan dalam eksport PDF.",
	"settings.svgCache": "SVG dimuat turun",
	"settings.svgCacheInfo": "{{count}} ikon · {{size}}",
	"settings.svgCacheEmpty": "Tiada SVG Material dicache lagi.",
	"settings.clearSvgCache": "Kosongkan",
	"settings.viewCachedSvgs": "Lihat",
	"settings.cachedSvgsTitle": "SVG Material yang dicache",
	...
	"settings.resetAllDesc": "Memadam semua callouts pengguna, menetapkan semula callouts terbina dalam, gaya global, dan SVG Material yang dimuat turun.",
	"settings.resetAllButton": "Set semula semua",
	"settings.resetAllConfirm": "Ini akan memadam semua callouts tersuai, menetapkan semula callouts terbina dalam, gaya global dan semua SVG Material yang dicache. Tindakan ini tidak boleh dibatalkan. Adakah anda pasti?",
	...
	"notice.iconDownloadFailed": 'Gagal memuat turun ikon Material "{{name}}". Semak sambungan internet anda.',
	...
	"editor.calloutIdsDesc": "Semua pengecam untuk callout ini. Tekan Enter atau Ruang untuk menambah.",
	...
	"editor.palettes": "Pratetap",
	"editor.paletteDefault": "Biru lalai",
	...
	"import.err.idBadChar": 'ID "{{value}}" mengandungi aksara tidak sah (ruang, "|", "[" atau "]" tidak dibenarkan).',
