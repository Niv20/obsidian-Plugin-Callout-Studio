export const ms: Record<string, string> = {
	...
	"editor.gradientEnd": "Penghujung gradien",
	"editor.text": "Teks",
	...
	"settings.calloutTypeRegularLocked": "Callout biasa ialah paparan asli Obsidian dan tidak boleh dimatikan.",
	"settings.roleEnabled": "Diaktifkan",
