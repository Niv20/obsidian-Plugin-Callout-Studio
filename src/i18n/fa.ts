export const fa: Record<string, string> = {
	...
	"locale.notDownloadedDesc": "Callout Studio تا زمان دانلود ترجمه، انگلیسی را نشان می‌دهد. دفعه بعد که Obsidian اجرا شود دوباره تلاش می‌کند.",
	"locale.retry": "تلاش دوباره",
	"locale.diskWriteFailed": "Callout Studio نتوانست ترجمه را روی دیسک ذخیره کند؛ بنابراین دفعه بعد باید دوباره دانلود شود.",
	...
	"notice.exportCssFailed": "ذخیره قطعه CSS ممکن نبود. برای جزئیات کنسول توسعه‌دهنده را بررسی کنید.",
	"notice.exportCssEnabled": "این قطعه در این vault فعال است. Callout Studio از قبل این کال‌اوت‌ها را سبک‌دهی می‌کند و قطعه، سبک زمان خروجی گرفتن را حفظ می‌کند.",
	"confirm.titleOverwriteSnippet": "بازنویسی قطعه CSS",
	"confirm.overwriteSnippet": "قطعه CSS در پوشه snippets از زمانی که Callout Studio آن را نوشته تغییر کرده است. خروجی گرفتن دوباره کل فایل را جایگزین می‌کند.",
	"confirm.overwriteSnippetOk": "بازنویسی",
	"export.chooseFormat": "خروجی به‌صورت",
	"export.formatJson": "پشتیبان Callout Studio",
	"export.formatJsonDesc": "یک فایل .json شامل کال‌اوت‌ها و تنظیمات شما برای وارد کردن به vault دیگر.",
	"export.formatCss": "قطعه CSS",
	"export.formatCssDesc": "یک فایل .css ذخیره‌شده در پوشه snippets این vault، برای استفاده جایی که Callout Studio نصب نیست. فقط کال‌اوت‌های معمولی را پوشش می‌دهد و یک عکس فوری است؛ پس از تغییر دوباره خروجی بگیرید.",
};
