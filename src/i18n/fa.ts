export const fa: Record<string, string> = {
	...
	"settings.iconSources": "آیکون‌های Google Material",
	"settings.iconSourcesDesc": "نام آیکون‌های Material و برچسب‌های جستجو برای مرور آفلاین همراه پلاگین هستند. Google Fonts و فایل‌های SVG (fonts.googleapis.com, fonts.gstatic.com) فقط هنگام پیش‌نمایش یا انتخاب آیکون Material بارگذاری می‌شوند؛ SVG‌های انتخاب‌شده به صورت محلی ذخیره می‌شوند. هیچ داده‌ای به Google ارسال نمی‌شود.",
	...
	"settings.colorPairAria": "روشن: {{light}} · تاریک: {{dark}}",
	...
	"settings.lucideIcons": "آیکون‌های Lucide",
	"settings.lucideIconsDesc": "آیکون‌های داخلی Obsidian (~۱٬۳۰۰ آیکون)",
	"settings.materialIcons": "آیکون‌های Google Material",
	"settings.materialIconsDesc": "نیاز به اینترنت یا حافظه نهان محلی (~۳٬۰۰۰ آیکون)",
	"settings.materialStyleDefault": "سبک پیش‌فرض آیکون‌های Material",
	"settings.styleOutlined": "خطی",
	"settings.styleFilled": "توپر",
	"settings.styleRounded": "گرد",
	"settings.styleSharp": "تیز",
	"settings.materialWeightDefault": "وزن پیش‌فرض آیکون‌های Material",
	"settings.materialWeightDefaultDesc": "ضخامت خط برای آیکون‌های Material (۱۰۰ = نازک، ۷۰۰ = ضخیم)",
	"settings.materialCache": "حافظه نهان آیکون‌های Material",
	"settings.materialCacheDesc": "SVG‌های منفرد آیکون‌های Material هنگام انتخاب برای callout دانلود می‌شوند تا آفلاین و در صادرات PDF کار کنند.",
	"settings.svgCache": "SVG‌های دانلود شده",
	"settings.svgCacheInfo": "{{count}} آیکون · {{size}}",
	"settings.svgCacheEmpty": "هنوز هیچ SVG Material در حافظه نهان نیست.",
	"settings.clearSvgCache": "پاک‌سازی",
	"settings.viewCachedSvgs": "مشاهده",
	"settings.cachedSvgsTitle": "SVG‌های Material در حافظه نهان",
	...
	"editor.calloutIdsDesc": "همه شناسه‌ها برای این callout. Enter یا فاصله را فشار دهید تا اضافه شود.",
	...
	"editor.palettes": "پیش‌تنظیم‌ها",
	"editor.paletteDefault": "آبی پیش‌فرض",
	...
	"import.err.idBadChar": 'شناسه "{{value}}" دارای کاراکترهای نامعتبر است (فاصله، "|"، "[" یا "]" مجاز نیستند).',
