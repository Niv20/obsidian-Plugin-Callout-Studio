export const ko: Record<string, string> = {
	...
	"palette.baseColorHint": "배경색을 자동으로 이 색상에 맞춥니다. 원하시면 {{link}}하여 별도로 설정할 수 있습니다.",
	"palette.baseColorHintLink": "여기를 클릭",
	"palette.advancedColors": "색상",
	"palette.advancedColorsHint": "{{mode}} 모드의 색상을 편집 중입니다 - 다른 모드는 자동으로 업데이트됩니다. 확인하려면 Obsidian 테마를 전환하세요.",
	...
	"iconPicker.tablerStyleOutline": "아웃라인",
	"iconPicker.tablerStyleFilled": "채워진",
	...
	"iconPicker.faStyleSolid": "솔리드",
	"iconPicker.faStyleRegular": "레귤러",
	"iconPicker.faStyleBrands": "브랜드",
	"iconPicker.rpgAwesome": "RPG Awesome",
	"iconPicker.searchRpgAwesome": "RPG Awesome 검색",
	"iconPicker.image": "내 이미지",
	"iconPicker.searchImage": "이미지 검색",
	"iconPicker.imageTooLarge": "{{name}}이(가) 너무 큽니다. 이미지는 5MB 미만이어야 합니다.",
	"iconPicker.imageUnsupported": "{{name}}은(는) 지원되지 않는 이미지 형식입니다. SVG, PNG, JPEG 또는 WebP를 사용하세요.",
	"iconPicker.imageInvalidSvg": "{{name}}을(를) 안전한 SVG로 읽을 수 없어 추가되지 않았습니다.",
	"iconPicker.imageDecodeFailed": "{{name}}을(를) 이미지로 읽을 수 없습니다.",
	"iconPicker.imageDuplicate": "{{name}}이(가) 이미 이미지에 있습니다. 파일 이름을 변경하거나 기존 이미지를 삭제하세요.",
	"iconPicker.imageAdd": "이미지 추가",
	"iconPicker.imageEmpty": "아직 이미지가 없습니다. 컴퓨터에서 SVG, PNG, JPEG 또는 WebP 파일을 추가하거나 여기에 끌어다 놓으세요.",
	"iconPicker.imageDelete": "삭제",
	"iconPicker.imageDeleteConfirm": "“{{name}}” 삭제하시겠습니까?",
	"iconPicker.imageDeleteInUse": "{{count}}개의 callout이 이 이미지를 사용합니다. 새 이미지를 지정할 때까지 자리 표시자 아이콘이 표시됩니다.",
	"iconPicker.imageRecolor": "Callout 색상 따르기",
	"iconPicker.allSources": "모든 소스",
	"iconPicker.searchAllSources": "모든 아이콘 소스 검색",
	"iconPicker.sourcesNotDownloaded": "아직 포함되지 않음: {{names}}. 위에서 소스를 선택하여 다운로드하세요.",
	...
	"iconPicker.descTabler": "깔끔하고 일관된 UI 아이콘, 아웃라인과 채워진 스타일",
	...
	"iconPack.downloadFailed": "{{name}}을(를) 다운로드할 수 없습니다. 연결을 확인하고 다시 시도하세요.",
	"iconPack.retry": "재시도",
	"iconPack.faBrandsNotice": "브랜드 아이콘은 각 소유자의 상표입니다. 포함되었다고 해서 지지를 의미하지 않습니다. 해당 회사, 제품 또는 서비스를 나타내기 위해서만 사용하세요.",
	"iconPack.artworkRestored": "{{names}}의 아이콘 아트워크를 다운로드했습니다.",
	"iconPack.diskWriteFailed": "Callout Studio가 아이콘 팩을 디스크에 저장할 수 없어 다음에 다시 다운로드해야 합니다. 선택한 아이콘은 설정에 저장되어 있습니다.",

	// Icon licences & credits
	"credits.title": "아이콘 라이선스 및 크레딧",
	"credits.intro": "Callout Studio는 여러 오픈 아이콘 라이브러리를 사용합니다. 라이선스는 아래에 재현되어 있으며, 여기서 사용하기 위해 변경된 내용도 포함되어 있습니다.",
	"credits.fullNotices": "전체 서드파티 고지사항",
	"credits.pluginLicense": "Callout Studio 자체 코드는 0BSD 라이선스입니다. 아이콘 라이브러리는 각자의 라이선스를 유지합니다.",
	...
	"import.err.iconTypeInvalid": "아이콘 유형 \"{{value}}\"은(는) {{types}} 중 하나여야 합니다.",
	"import.warn.iconFieldIgnored": "\"{{field}}\"은(는) Material 아이콘에만 적용되며 아이콘 유형 {{type}}에 대해서는 무시됩니다.",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\"은(는) 직접 추가한 이미지에만 적용되며 아이콘 유형 {{type}}에 대해서는 무시됩니다.",
	"import.err.iconRecolorInvalid": "\"recolor\"은(는) true 또는 false여야 합니다 (받음: \"{{value}}\").",
	...
	"import.warn.imageMissing": "이 Callout은 파일에도, 이 vault에도 없는 이미지를 사용하므로 새 이미지를 지정할 때까지 자리 표시자 아이콘이 표시됩니다.",
