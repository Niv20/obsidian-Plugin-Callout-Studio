export const sv: Record<string, string> = {
	...
	"editor.gradientEnd": "Gradientslut",
	"editor.text": "Text",
	...
	"settings.calloutTypeRegularLocked": "Vanliga callouts är Obsidians inbyggda rendering och kan inte stängas av.",
	"settings.roleEnabled": "Aktiverad",
