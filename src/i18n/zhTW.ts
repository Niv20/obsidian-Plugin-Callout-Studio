export const zhTW: Record<string, string> = {
	...
	"settings.showEditCallout": '顯示「編輯 callout 設定」',
	"settings.showOpenSettings": '顯示「開啟 Callout Studio 設定」',
	"settings.showCopyMarkdown": '顯示「複製 callout Markdown」',
	"settings.enableAutocomplete": "啟用 [! 自動完成",
	"settings.enableAutocompleteDesc": '在編輯器區塊引用中輸入「[!」時顯示建議。從清單中選擇 callout 類型以插入完整的 callout 標題。',
	"settings.showIconPreviews": "在自動完成中顯示圖示預覽",
	"settings.showColorPreviews": "顯示色彩預覽",
	...
	"editor.calloutIdsDesc": "此 callout 的所有識別符。按 Enter 或空格鍵新增。",
	...
	"import.err.idBadChar": 'ID「{{value}}」包含無效字元（不允許空白字元、「|」、「[」或「]」）。',
