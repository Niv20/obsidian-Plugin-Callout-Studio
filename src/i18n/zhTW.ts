export const zhTW: Record<string, string> = {
	...
	"locale.notDownloadedDesc": "在翻譯下載完成前，Callout Studio 會顯示英文。下次啟動 Obsidian 時會重試。",
	"locale.retry": "重試",
	"locale.diskWriteFailed": "Callout Studio 無法將翻譯儲存到磁碟，因此下次需要重新下載。",
	...
	"notice.exportCssFailed": "無法儲存 CSS 片段。請查看開發者主控台以瞭解詳情。",
	"notice.exportCssEnabled": "此片段已在此儲存庫中啟用。Callout Studio 已經為這些 callout 設定樣式，而片段保留匯出時的樣式。",
	"confirm.titleOverwriteSnippet": "覆寫 CSS 片段",
	"confirm.overwriteSnippet": "snippets 資料夾中的 CSS 片段自 Callout Studio 寫入後已變更。再次匯出會取代整個檔案。",
	"confirm.overwriteSnippetOk": "覆寫",
	"export.chooseFormat": "匯出為",
	"export.formatJson": "Callout Studio 備份",
	"export.formatJsonDesc": "包含 callout 和設定的 .json 檔案，可匯入其他儲存庫。",
	"export.formatCss": "CSS 片段",
	"export.formatCssDesc": "儲存在此儲存庫 snippets 資料夾中的 .css 檔案，可在未安裝 Callout Studio 的地方使用。僅涵蓋一般 callout，是一份快照；變更 callout 後請重新匯出。",
};
