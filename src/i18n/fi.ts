export const fi: Record<string, string> = {
	...
	"settings.showEditCallout": 'Näytä "muokkaa callout-asetuksia"',
	"settings.showOpenSettings": 'Näytä "avaa Callout Studio -asetukset"',
	"settings.showCopyMarkdown": 'Näytä "kopioi callout Markdown"',
	...
	"settings.showIconPreviews": "Näytä kuvakeesikatselut automaattisessa täydennyksessä",
	"settings.showColorPreviews": "Näytä väriesikatselut",
	...
	"editor.calloutIdsDesc": "Kaikki tämän calloutin tunnisteet. Paina Enter tai Välilyönti lisätäksesi.",
	...
	"import.err.idBadChar": 'Tunnus "{{value}}" sisältää virheellisiä merkkejä (välilyönnit, "|", "[" tai "]" eivät ole sallittuja).',
