export const th: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "ตัวระบุทั้งหมดสำหรับ callout นี้ กด Enter หรือ Space เพื่อเพิ่ม",
	...
	"import.err.idBadChar": 'ID "{{value}}" มีอักขระที่ไม่ถูกต้อง (ไม่อนุญาตให้ใช้ช่องว่าง "|" "[" หรือ "]")',
