export const it: Record<string, string> = {
	...
	"welcome.tagline": "La tua soluzione completa per gestire i callout di Obsidian.",
	...
	"settings.refGroup": "Schema e link",
	...
	"editor.idCannotDelete": "Questo ID è collegato al nome visualizzato e non può essere eliminato — modifica il nome per cambiarlo",
	"editor.icon": "Icona",
	"editor.light": "Chiaro",
	"editor.dark": "Scuro",
	...
	"editor.gradientEnd": "Fine sfumatura",
	"editor.text": "Testo",
	...
	"editor.contrastWarning": "Contrasto basso rispetto allo sfondo — potrebbe essere difficile da leggere",
	...
	"palette.baseColorHint": "Adatteremo automaticamente il colore di sfondo a questo. Se preferisci, puoi controllarlo separatamente {{link}}.",
	"palette.baseColorHintLink": "cliccando qui",
	"palette.advancedColors": "Colori",
	"palette.advancedColorsHint": "Modifica dei colori per la modalità {{mode}} - l'altra modalità si aggiorna automaticamente. Cambia il tema di Obsidian per verificarlo.",
	...
	"iconPicker.tablerStyleFilled": "Pieno",
	...
	"iconPicker.faStyleSolid": "Pieno",
	"iconPicker.faStyleRegular": "Normale",
	"iconPicker.faStyleBrands": "Marchi",
	...
	"iconPicker.imageTooLarge": "{{name}} è troppo grande. Le immagini devono essere inferiori a 5 MB.",
	"iconPicker.imageUnsupported": "{{name}} non è un formato immagine supportato. Usa SVG, PNG, JPEG o WebP.",
	"iconPicker.imageInvalidSvg": "{{name}} non può essere letto come SVG sicuro e non è stato aggiunto.",
	"iconPicker.imageDecodeFailed": "{{name}} non può essere letto come immagine.",
	"iconPicker.imageDuplicate": "{{name}} è già nelle tue immagini. Rinomina il file o elimina l'immagine esistente.",
	"iconPicker.imageAdd": "Aggiungi immagini",
	"iconPicker.imageEmpty": "Nessuna immagine ancora. Aggiungi un file SVG, PNG, JPEG o WebP dal tuo computer o trascinalo qui.",
	"iconPicker.imageDelete": "Elimina",
	"iconPicker.imageDeleteConfirm": "Eliminare “{{name}}”?",
	"iconPicker.imageDeleteInUse": "{{count}} callout usano questa immagine. Mostreranno un'icona segnaposto finché non ne fornisci una nuova.",
	...
	"iconPicker.sourcesNotDownloaded": "Non ancora incluso: {{names}}. Scegli una fonte sopra per scaricarlo.",
	"iconPicker.chooseSource": "Scegli fonte",
	"iconPicker.sourceGroup": "{{name}} · {{count}}",

	// Source menu — what each library holds, in a few words
	"iconPicker.descAllSources": "cerca in tutte le librerie contemporaneamente",
	"iconPicker.descLucide": "il set di Obsidian, sempre offline",
	"iconPicker.descTabler": "icone UI pulite e coerenti, contorno e pieno",
	"iconPicker.descMaterial": "il set di Google, quattro stili e sette spessori",
	...
	"iconPack.downloadFailed": "Impossibile scaricare {{name}}. Controlla la connessione e riprova.",
	"iconPack.retry": "Riprova",
	"iconPack.faBrandsNotice": "Le icone dei marchi sono marchi registrati dei rispettivi proprietari. La loro inclusione non indica un'approvazione. Usale solo per rappresentare l'azienda, il prodotto o il servizio a cui si riferiscono.",
	"iconPack.artworkRestored": "L'artwork delle icone per {{names}} è stato scaricato.",
	"iconPack.diskWriteFailed": "Callout Studio non è riuscito a salvare il pacchetto di icone su disco, quindi dovrà essere scaricato di nuovo la prossima volta. Le icone che scegli sono comunque salvate nelle tue impostazioni.",

	// Icon licences & credits
	"credits.title": "Licenze icone e crediti",
	"credits.intro": "Callout Studio si basa su diverse librerie di icone aperte. Le loro licenze sono riprodotte di seguito, insieme a ciò che è stato modificato per usarle qui.",
	"credits.fullNotices": "Avvisi terze parti completi",
	"credits.pluginLicense": "Il codice proprio di Callout Studio è sotto licenza 0BSD; le librerie di icone mantengono le proprie licenze.",
	...
	"settings.calloutTypeRegularLocked": "I callout normali sono il rendering nativo di Obsidian e non possono essere disattivati.",
	"settings.roleEnabled": "Abilitato",
	...
	"import.warn.invalidGradient": "Il gradiente dello sfondo non era valido ed è stato ignorato.",
	...
	"import.err.iconTypeInvalid": "Il tipo di icona \"{{value}}\" non è uno tra: {{types}}.",
	"import.warn.iconFieldIgnored": "\"{{field}}\" si applica solo alle icone Material ed è ignorato per il tipo di icona {{type}}.",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\" si applica solo alle proprie immagini ed è ignorato per il tipo di icona {{type}}.",
	"import.err.iconRecolorInvalid": "\"recolor\" deve essere true o false (ricevuto: \"{{value}}\").",
	...
	"import.warn.imageMissing": "Questo Callout usa un'immagine che non è nel file e non è in questo vault, quindi mostrerà un'icona segnaposto finché non ne fornisci una nuova.",
