export const hi: Record<string, string> = {
	...
	"editor.idCannotDelete": "यह ID प्रदर्शन नाम से जुड़ी है और इसे हटाया नहीं जा सकता — बदलने के लिए नाम संपादित करें",
	"editor.icon": "आइकन",
	"editor.light": "उजला",
	"editor.dark": "गाढ़ा",
	...
	"editor.gradientEnd": "ग्रेडिएंट अंत",
	"editor.text": "टेक्स्ट",
	...
	"editor.contrastWarning": "पृष्ठभूमि की तुलना में कम कंट्रास्ट — पढ़ना मुश्किल हो सकता है",
	...
	"palette.baseColorHint": "हम पृष्ठभूमि के रंग को स्वतः इससे मिला देंगे। यदि आप चाहें, तो {{link}} करके इसे अलग से नियंत्रित कर सकते हैं।",
	"palette.baseColorHintLink": "यहां क्लिक करें",
	"palette.advancedColors": "रंग",
	"palette.advancedColorsHint": "{{mode}} मोड के लिए रंग संपादित किए जा रहे हैं - दूसरा मोड स्वतः अपडेट हो जाता है। इसे जांचने के लिए Obsidian की थीम बदलें।",
	...
	"iconPicker.tablerStyleOutline": "आउटलाइन",
	"iconPicker.tablerStyleFilled": "भरा हुआ",
	...
	"iconPicker.faStyleSolid": "ठोस",
	"iconPicker.faStyleRegular": "सामान्य",
	"iconPicker.faStyleBrands": "ब्रांड",
	...
	"iconPicker.imageTooLarge": "{{name}} बहुत बड़ा है। चित्र 5 MB से कम होने चाहिए।",
	"iconPicker.imageUnsupported": "{{name}} एक समर्थित चित्र प्रारूप नहीं है। SVG, PNG, JPEG या WebP उपयोग करें।",
	"iconPicker.imageInvalidSvg": "{{name}} को सुरक्षित SVG के रूप में नहीं पढ़ा जा सका, इसलिए इसे नहीं जोड़ा गया।",
	"iconPicker.imageDecodeFailed": "{{name}} को चित्र के रूप में नहीं पढ़ा जा सका।",
	"iconPicker.imageDuplicate": "{{name}} पहले से ही आपकी छवियों में है। फ़ाइल का नाम बदलें या मौजूदा चित्र हटाएं।",
	"iconPicker.imageAdd": "छवियां जोड़ें",
	"iconPicker.imageEmpty": "अभी तक कोई चित्र नहीं। अपने कंप्यूटर से SVG, PNG, JPEG या WebP फ़ाइल जोड़ें या यहां खींचें।",
	"iconPicker.imageDelete": "हटाएं",
	"iconPicker.imageDeleteConfirm": "“{{name}}” हटाएं?",
	"iconPicker.imageDeleteInUse": "{{count}} callouts इस चित्र का उपयोग करते हैं। नया देने तक वे एक प्लेसहोल्डर आइकन दिखाएंगे।",
	...
	"iconPicker.sourcesNotDownloaded": "अभी तक शामिल नहीं: {{names}}। डाउनलोड करने के लिए ऊपर एक स्रोत चुनें।",
	...
	"iconPack.downloadFailed": "{{name}} डाउनलोड नहीं हो सका। कनेक्शन जांचें और पुनः प्रयास करें।",
	"iconPack.retry": "पुनः प्रयास करें",
	"iconPack.faBrandsNotice": "ब्रांड आइकन उनके संबंधित स्वामियों के ट्रेडमार्क हैं। उनका समावेश समर्थन का संकेत नहीं देता। कृपया उन्हें केवल उस कंपनी, उत्पाद या सेवा का प्रतिनिधित्व करने के लिए उपयोग करें जिसे वे संदर्भित करते हैं।",
	"iconPack.artworkRestored": "{{names}} के लिए आइकन आर्टवर्क डाउनलोड किया गया।",
	"iconPack.diskWriteFailed": "Callout Studio आइकन पैक को डिस्क पर सहेज नहीं सका, इसलिए अगली बार फिर से डाउनलोड करना होगा। आपके द्वारा चुने गए आइकन आपकी सेटिंग के साथ सहेजे गए हैं।",

	// Icon licences & credits
	"credits.title": "आइकन लाइसेंस और श्रेय",
	"credits.intro": "Callout Studio कई खुली आइकन लाइब्रेरी पर निर्भर करता है। उनके लाइसेंस नीचे पुनः प्रस्तुत किए गए हैं, साथ ही यहां उनके उपयोग के लिए क्या बदला गया।",
	"credits.fullNotices": "पूर्ण तृतीय-पक्ष सूचनाएं",
	"credits.pluginLicense": "Callout Studio का अपना कोड 0BSD लाइसेंस के अंतर्गत है; आइकन लाइब्रेरी अपने लाइसेंस बनाए रखती हैं।",
	...
	"settings.globalSettingsDesc": "अपने पूरे vault में प्रत्येक callout प्रकार का रूप बारीकी से समायोजित करें।",
	"settings.globalSettingsRegularDesc": "Obsidian के मूल callout बॉक्स को दिखाने के लिए किसी उद्धरण में एक callout टोकन जोड़ें (जैसे, `> [!type]`)। आप इसका बॉर्डर, रेडियस, फ़ॉन्ट स्केल और संरेखण समायोजित कर सकते हैं।",
	"settings.globalSettingsHeadingDesc": "इसे स्टाइल किए गए callout शीर्षक के रूप में दिखाने के लिए शीर्षक के # चिह्नों के ठीक बाद एक callout टोकन जोड़ें (जैसे, `## [!type]`)। आप इसका बॉर्डर, आकार और ऊर्ध्वाधर दूरी समायोजित कर सकते हैं।",
	"settings.globalSettingsInlineDesc": "इसे एक छोटे इनलाइन पिल के रूप में दिखाने के लिए टेक्स्ट की किसी भी पंक्ति के भीतर कहीं भी एक callout टोकन जोड़ें (जैसे, `[!type]`)। आप इसका बॉर्डर और आकार समायोजित कर सकते हैं।",
	"settings.globalSettingsCustomize": "कस्टमाइज़ करें",
	"settings.calloutTypes": "callout प्रकार",
	"settings.calloutTypeRegular": "सामान्य callout",
	"settings.calloutTypeRegularDesc": "सामग्री के साथ एक उद्धरण callout: > [!name]। हमेशा सक्षम।",
	"settings.calloutTypeRegularLocked": "सामान्य callouts Obsidian की मूल रेंडरिंग हैं और इन्हें बंद नहीं किया जा सकता।",
	"settings.roleEnabled": "सक्षम",
	"settings.calloutTypeHeading": "शीर्षक callout",
	"settings.calloutTypeHeadingDesc": "एक शीर्षक जिसकी पहली सामग्री टोकन है, जैसे ## [!name]। शीर्षक के फ़ॉन्ट आकार में रंगीन पट्टी के रूप में दिखाया जाता है। फ़ाइल खोलने पर पूरे अनुभाग को खोलने/बंद करने के लिए टोकन के बाद + / - का उपयोग करें।",
	"settings.calloutTypeInline": "इनलाइन callout",
	"settings.calloutTypeInlineDesc": "एक पंक्ति के बीच में [!name] टोकन, जिसे छोटे पिल के रूप में दिखाया जाता है। कोई शीर्षक या सामग्री नहीं।",
	"settings.refCleanTitles": "आउटलाइन और लिंक में शीर्षक साफ़ करें",
	"settings.refCleanTitlesDesc": "जहां भी शीर्षक callout का संदर्भ दिया जाता है वहां [!name] टोकन छिपाता है: आउटलाइन पैनल, शीर्षक के लिंक (सामग्री तालिका सहित), और लिंक सुझाव पॉपअप। बिना शीर्षक टेक्स्ट वाले शीर्षक callout का प्रदर्शन नाम दिखाते हैं।",
	...
	"settings.customizeMenuDesc": "चुनें कि प्रत्येक callout प्रकार के लिए कौन-सी राइट-क्लिक क्रियाएँ दिखाई दें और उनका क्रम बदलें। सोर्स मोड और लाइव प्रीव्यू में काम करता है।",
	...
	"menuCustomize.moveUp": "ऊपर ले जाएँ",
	"menuCustomize.moveDown": "नीचे ले जाएँ",
	...
	"import.err.notRecognized": "अपरिचित फ़ाइल: callout परिभाषाओं का array या Callout Studio एक्सपोर्ट अपेक्षित था।",
	"import.warn.settingsIgnored": "सेटिंग ब्लॉक एक वैध ऑब्जेक्ट नहीं था और इसे अनदेखा कर दिया गया।",
	"import.warn.invalidGradient": "पृष्ठभूमि ग्रेडिएंट वैध नहीं था और इसे अनदेखा कर दिया गया।",
	...
	"import.err.iconTypeInvalid": "आइकन प्रकार \"{{value}}\" इनमें से एक होना चाहिए: {{types}}।",
	"import.warn.iconFieldIgnored": "\"{{field}}\" केवल Material आइकन पर लागू होता है और आइकन प्रकार {{type}} के लिए अनदेखा किया जाता है।",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\" केवल आपके अपने चित्रों पर लागू होता है और आइकन प्रकार {{type}} के लिए अनदेखा किया जाता है।",
	"import.err.iconRecolorInvalid": "\"recolor\" true या false होना चाहिए (प्राप्त: \"{{value}}\")।",
	...
	"import.warn.imageMissing": "यह Callout एक ऐसे चित्र का उपयोग करता है जो फ़ाइल में और इस vault में नहीं है, इसलिए नया देने तक एक प्लेसहोल्डर आइकन दिखाएगा।",
