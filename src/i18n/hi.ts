export const hi: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "इस callout के सभी पहचानकर्ता। जोड़ने के लिए Enter या Space दबाएँ।",
	...
	"import.err.idBadChar": 'ID "{{value}}" में अमान्य अक्षर हैं (व्हाइटस्पेस, "|", "[" या "]" अनुमत नहीं)।',
