export const ru: Record<string, string> = {
	...
	"editor.gradientEnd": "Конец градиента",
	"editor.text": "Текст",
	...
	"settings.calloutTypeRegularLocked": "Обычные callout — это встроенный рендеринг Obsidian, и его нельзя отключить.",
	"settings.roleEnabled": "Включено",
