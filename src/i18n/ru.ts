export const ru: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "Все идентификаторы этого callout. Нажмите Enter или пробел для добавления.",
	...
	"import.err.idBadChar": 'ID "{{value}}" содержит недопустимые символы (пробелы, "|", "[" или "]" не разрешены).',
