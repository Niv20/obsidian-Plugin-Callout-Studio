export const ja: Record<string, string> = {
	...
	"settings.iconSources": "Google Materialアイコン",
	"settings.iconSourcesDesc": "Materialアイコン名と検索タグはオフライン閲覧用に同梱されています。Google FontsおよびSVGファイル（fonts.googleapis.com、fonts.gstatic.com）はMaterialアイコンのプレビューまたは選択時のみ読み込まれ、選択したSVGはローカルにキャッシュされます。Googleにデータは送信されません。",
	...
	"settings.lucideIcons": "Lucideアイコン",
	"settings.lucideIconsDesc": "Obsidian組み込みアイコン（約1,300個）",
	"settings.materialIcons": "Google Materialアイコン",
	"settings.materialIconsDesc": "インターネットまたはローカルキャッシュが必要（約3,000個）",
	"settings.materialStyleDefault": "Materialアイコンのデフォルトスタイル",
	"settings.styleOutlined": "アウトライン",
	"settings.styleFilled": "フィル",
	"settings.styleRounded": "ラウンド",
	"settings.styleSharp": "シャープ",
	"settings.materialWeightDefault": "Materialアイコンのデフォルト太さ",
	"settings.materialWeightDefaultDesc": "Materialアイコンのストロークの太さ（100 = 細い、700 = 太い）",
	"settings.materialCache": "MaterialアイコンキャッシュMaterial icon cache",
	"settings.materialCacheDesc": "calloutのアイコンを選択すると個別のMaterial SVGがダウンロードされ、オフラインやPDFエクスポートで使用できます。",
	"settings.svgCache": "ダウンロード済みSVG",
	"settings.svgCacheInfo": "{{count}}アイコン · {{size}}",
	"settings.svgCacheEmpty": "Material SVGはまだキャッシュされていません。",
	"settings.clearSvgCache": "クリア",
	"settings.viewCachedSvgs": "表示",
	"settings.cachedSvgsTitle": "キャッシュ済みMaterial SVG",
	...
	"editor.calloutIdsDesc": "このcalloutのすべての識別子。EnterまたはSpaceを押して追加します。",
	...
	"import.err.idBadChar": 'ID"{{value}}"に無効な文字が含まれています（空白、"|"、"["、"]"は使用できません）。',
