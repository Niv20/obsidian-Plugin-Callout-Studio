export const ja: Record<string, string> = {
	...
	"editor.idCannotDelete": "このIDは表示名にリンクされているため削除できません。名前を編集して変更してください",
	"editor.icon": "アイコン",
	"editor.light": "ライト",
	"editor.dark": "ダーク",
	...
	"editor.contrastWarning": "背景とのコントラストが低く、読みにくい場合があります",
	...
	"palette.baseColorHint": "背景色を自動的にこの色に合わせます。ご希望であれば、{{link}}で個別に設定することもできます。",
	"palette.baseColorHintLink": "ここをクリック",
	"palette.advancedColors": "色",
	"palette.advancedColorsHint": "{{mode}}モードの色を編集中 - もう一方のモードは自動的に更新されます。確認するにはObsidianのテーマを切り替えてください。",
	...
	"iconPicker.tablerStyleOutline": "アウトライン",
	"iconPicker.tablerStyleFilled": "塗りつぶし",
	...
	"iconPicker.imageTooLarge": "{{name}}は大きすぎます。画像は5MB未満にしてください。",
	"iconPicker.imageUnsupported": "{{name}}はサポートされている画像形式ではありません。SVG、PNG、JPEG、またはWebPを使用してください。",
	"iconPicker.imageInvalidSvg": "{{name}}は安全なSVGとして読み取れなかったため、追加されませんでした。",
	"iconPicker.imageDecodeFailed": "{{name}}は画像として読み取れませんでした。",
	"iconPicker.imageDuplicate": "{{name}}はすでにあなたの画像にあります。ファイル名を変更するか、既存の画像を削除してください。",
	"iconPicker.imageAdd": "画像を追加",
	"iconPicker.imageEmpty": "画像がまだありません。コンピューターからSVG、PNG、JPEG、またはWebPファイルを追加するか、ここにドロップしてください。",
	"iconPicker.imageDelete": "削除",
	"iconPicker.imageDeleteConfirm": "「{{name}}」を削除しますか？",
	"iconPicker.imageDeleteInUse": "{{count}}個のcalloutがこの画像を使用しています。新しい画像を指定するまで、プレースホルダーアイコンが表示されます。",
	"iconPicker.imageRecolor": "Calloutのカラーに合わせる",
	"iconPicker.allSources": "すべてのソース",
	"iconPicker.searchAllSources": "すべてのアイコンソースを検索",
	"iconPicker.sourcesNotDownloaded": "未取得: {{names}}。上からソースを選んでダウンロードしてください。",
	...
	"iconPicker.descTabler": "シンプルで統一感のあるUIアイコン、アウトラインと塗りつぶし",
	...
	"iconPack.downloadDetail": "{{count}}個のアイコン · {{size}} · 一度限りのダウンロード",
	"iconPack.download": "ダウンロード",
	"iconPack.downloading": "{{name}}をダウンロード中…",
	"iconPack.downloadFailed": "{{name}}をダウンロードできませんでした。接続を確認して再試行してください。",
	"iconPack.retry": "再試行",
	"iconPack.faBrandsNotice": "ブランドアイコンはそれぞれの所有者の商標です。それらの掲載は推薦を意味しません。それらが指す会社、製品、またはサービスを表すためにのみ使用してください。",
	"iconPack.artworkRestored": "{{names}}のアイコンアートワークをダウンロードしました。",
	"iconPack.diskWriteFailed": "Callout Studioはアイコンパックをディスクに保存できませんでした。次回また再ダウンロードが必要です。選んだアイコンは設定に保存されています。",

	// Icon licences & credits
	"credits.title": "アイコンライセンスとクレジット",
	"credits.intro": "Callout Studioはいくつかのオープンなアイコンライブラリを使用しています。それらのライセンスと、ここでの使用のために変更された点を以下に掲載します。",
	"credits.fullNotices": "サードパーティの完全な通知",
	"credits.pluginLicense": "Callout Studio自体のコードは0BSDライセンスです。アイコンライブラリはそれぞれのライセンスを保持します。",
	...
	"settings.calloutTypeRegularLocked": "通常のcalloutはObsidianのネイティブレンダリングであり、オフにすることはできません。",
	"settings.roleEnabled": "有効",
	...
	"import.warn.invalidGradient": "背景のグラデーションが無効だったため、無視されました。",
	...
	"import.err.iconTypeInvalid": "アイコンタイプ\"{{value}}\"は{{types}}のいずれかでなければなりません。",
	"import.warn.iconFieldIgnored": "\"{{field}}\"はMaterialアイコンにのみ適用され、アイコンタイプ{{type}}では無視されます。",
	...
	"import.warn.iconRecolorIgnored": "\"recolor\"はあなた自身の画像にのみ適用され、アイコンタイプ{{type}}では無視されます。",
	"import.err.iconRecolorInvalid": "\"recolor\"はtrueまたはfalseでなければなりません（受け取った値: \"{{value}}\")。",
	...
	"import.warn.imageMissing": "このCalloutはファイルにもこのvaultにも存在しない画像を使用しています。新しい画像を指定するまでプレースホルダーアイコンが表示されます。",
