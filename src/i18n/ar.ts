export const ar: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "جميع معرّفات هذا الـ callout. اضغط Enter أو المسافة للإضافة.",
	...
	"import.err.idBadChar": 'يحتوي المعرّف "{{value}}" على أحرف غير صالحة (المسافات البيضاء و"|" و"[" و"]" غير مسموح بها).',
