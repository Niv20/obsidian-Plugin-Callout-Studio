export const ar: Record<string, string> = {
	...
	"editor.gradientEnd": "نهاية التدرج",
	"editor.text": "النص",
	...
	"settings.calloutTypeRegularLocked": "الـ callouts العادية هي طريقة العرض الأصلية في Obsidian ولا يمكن إيقافها.",
	"settings.roleEnabled": "مفعّل",
