export const nl: Record<string, string> = {
	...
	"settings.iconSources": "Google Material-pictogrammen",
	"settings.iconSourcesDesc": "Namen van Material-pictogrammen en zoektags worden meegeleverd voor offline browsen. Google Fonts en SVG-bestanden (fonts.googleapis.com, fonts.gstatic.com) worden alleen geladen wanneer u een Material-pictogram bekijkt of selecteert; geselecteerde SVG's worden lokaal gecacht. Er worden geen gegevens naar Google verzonden.",
	...
	"settings.colorPairAria": "Licht: {{light}} · Donker: {{dark}}",
	...
	"settings.lucideIcons": "Lucide-pictogrammen",
	"settings.lucideIconsDesc": "Ingebouwde Obsidian-pictogrammen (~1.300 pictogrammen)",
	"settings.materialIcons": "Google Material-pictogrammen",
	"settings.materialIconsDesc": "Vereist internet of lokale cache (~3.000 pictogrammen)",
	"settings.materialStyleDefault": "Standaard stijl Material-pictogrammen",
	"settings.styleOutlined": "Omlijnd",
	"settings.styleFilled": "Gevuld",
	"settings.styleRounded": "Afgerond",
	"settings.styleSharp": "Scherp",
	"settings.materialWeightDefault": "Standaard gewicht Material-pictogrammen",
	"settings.materialWeightDefaultDesc": "Lijndikte voor Material-pictogrammen (100 = dun, 700 = vet)",
	"settings.materialCache": "Material-pictogrammencache",
	"settings.materialCacheDesc": "Afzonderlijke SVG's van Material-pictogrammen worden gedownload wanneer u er een selecteert voor een callout, zodat ze offline en bij PDF-export werken.",
	"settings.svgCache": "Gedownloade SVG's",
	"settings.svgCacheInfo": "{{count}} pictogrammen · {{size}}",
	"settings.svgCacheEmpty": "Nog geen Material SVG's in cache.",
	"settings.clearSvgCache": "Wissen",
	"settings.viewCachedSvgs": "Bekijken",
	"settings.cachedSvgsTitle": "Gecachte Material SVG's",
	...
	"editor.calloutIdsDesc": "Alle identificatoren voor deze callout. Druk op Enter of Spatie om toe te voegen.",
	...
	"editor.palettes": "Voorinstellingen",
	"editor.paletteDefault": "Standaard blauw",
	...
	"import.err.idBadChar": 'De ID "{{value}}" bevat ongeldige tekens (witruimte, "|", "[" of "]" zijn niet toegestaan).',
