export const id: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "Semua pengidentifikasi untuk callout ini. Tekan Enter atau Spasi untuk menambahkan.",
	...
	"import.err.idBadChar": 'ID "{{value}}" mengandung karakter tidak valid (spasi, "|", "[", atau "]" tidak diizinkan).',
