export const id: Record<string, string> = {
	...
	"locale.notDownloadedDesc": "Callout Studio menampilkan bahasa Inggris sampai terjemahan dapat diunduh. Akan mencoba lagi saat Obsidian dijalankan berikutnya.",
	"locale.retry": "Coba lagi",
	"locale.diskWriteFailed": "Callout Studio tidak dapat menyimpan terjemahan ke disk, jadi terjemahan perlu diunduh lagi nanti.",
	...
	"notice.exportCssFailed": "Cuplikan CSS tidak dapat disimpan. Periksa konsol pengembang untuk detailnya.",
	"notice.exportCssEnabled": "Cuplikan ini diaktifkan di vault ini. Callout Studio sudah memberi gaya pada callout tersebut, dan cuplikan mempertahankan gaya saat diekspor.",
	"confirm.titleOverwriteSnippet": "Timpa cuplikan CSS",
	"confirm.overwriteSnippet": "Cuplikan CSS di folder snippets berubah sejak ditulis oleh Callout Studio. Mengekspor lagi akan mengganti seluruh file.",
	"confirm.overwriteSnippetOk": "Timpa",
	"export.chooseFormat": "Ekspor sebagai",
	"export.formatJson": "Cadangan Callout Studio",
	"export.formatJsonDesc": "File .json berisi callout dan pengaturan Anda untuk diimpor ke vault lain.",
	"export.formatCss": "Cuplikan CSS",
	"export.formatCssDesc": "File .css yang disimpan di folder snippets vault ini, untuk digunakan saat Callout Studio tidak terpasang. Hanya mencakup callout biasa dan merupakan snapshot; ekspor lagi setelah mengubah callout.",
};
