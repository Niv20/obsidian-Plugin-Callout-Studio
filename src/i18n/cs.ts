export const cs: Record<string, string> = {
	...
	"editor.calloutIdsDesc": "Všechny identifikátory tohoto callout. Stiskněte Enter nebo mezerník pro přidání.",
	...
	"import.err.idBadChar": 'ID "{{value}}" obsahuje neplatné znaky (mezery, "|", "[" nebo "]" nejsou povoleny).',
